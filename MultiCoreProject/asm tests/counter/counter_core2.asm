...
add $r2, $imm, $zero, 2		    # PC:1, Set core number to 2 
lw $r3, $zero, $zero, 0		    # PC:2, Load the counter value from address 0 into register r3 (global counter value)
and $r5, $r3, $imm, 3			# PC:3, If r5 (modulo 4 result) is not equal to the core number (r2), jump to polling (PC = 2)
bne $imm, $r5, $r2, 2			# PC:4, if r5 != r2, jump to PC=2 (if not my turn, keep polling)
...
sw $r3, $zero, $zero, 0		    # PC:8, Store the updated global counter value (r3) back into memory address 0
