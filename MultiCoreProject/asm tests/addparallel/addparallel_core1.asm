...
# Load base addresses:
#############################################################################################################
add $r2, $zero, $imm, 0x400     # pc = 0, Base address of Vector 1 (1024)
add $r3, $zero, $imm, 0xA00     # pc = 1, Base address of Vector 2 is 5120 (0 + 2560), cont in next line
add $r3, $r3, $imm, 0xA00       # pc = 2, Base address of Vector 2 is 5120 (2560 + 2560)
add $r4, $r3, $imm, 0x800       # pc = 3, Base address of Sum Vector is 9216 (5120 + 2048), cont in next line
add $r4, $r4, $imm, 0x800       # pc = 4, Base address of Sum Vector is 9216 (7168 + 2048)
