...
# Load base addresses:
#############################################################################################################
add $r2, $zero, $imm, 0xC00     # pc = 0, Base address of Vector 1 (1024)
add $r3, $zero, $imm, 0xE00     # pc = 1, Base address of Vector 2 is 7168 (0 + 3584), cont in next line
add $r3, $r3, $imm, 0xE00       # pc = 2, Base address of Vector 2 is 7168 (3584 + 3584)
add $r4, $r3, $imm, 0x800       # pc = 3, Base address of Sum Vector is 11264 (7168 + 2048), cont in next line
add $r4, $r4, $imm, 0x800       # pc = 4, Base address of Sum Vector is 11264 (9216 + 2048)
