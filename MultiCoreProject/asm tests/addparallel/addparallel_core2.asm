...
# Load base addresses:
#############################################################################################################
add $r2, $zero, $imm, 0x800     # pc = 0, Base address of Vector 1 (1024)
add $r3, $zero, $imm, 0xC00     # pc = 1, Base address of Vector 2 is 6144 (0 + 3072), cont in next line
add $r3, $r3, $imm, 0xC00       # pc = 2, Base address of Vector 2 is 6144 (3072 + 3072)
add $r4, $r3, $imm, 0x800       # pc = 3, Base address of Sum Vector is 10240 (6144 + 2048), cont in next line
add $r4, $r4, $imm, 0x800       # pc = 4, Base address of Sum Vector is 10240 (8192 + 2048)
add $r5, $zero, $imm, 256       # pc = 5, Loop counter is 256 (256 iterations of 4 elements)
#############################################################################################################
